import {
  ...
  withRetry,
  withTimeout
} from "./chunk-6FB4W64Q.js";
import "./chunk-RVTYCCZB.js";
import "./chunk-J6ASUUDN.js";
import {
    ...
    async getProvider() {
      if (!walletProvider) {
        ...
        const { createBaseAccountSDK } = await (() => {
          try {
            return import("./connectors_false-Y3XR7PGM.js");
          } catch {
    ...
    async getProvider() {
      if (!walletProvider) {
        const { createCoinbaseWalletSDK } = await (() => {
          try {
            return import("./connectors_false-OSJ4DI3E.js");
          } catch {
    ...
    async getProvider() {
      if (!walletProvider) {
        const { GeminiWalletProvider } = await (() => {
          try {
            return import("./connectors_false-P3M2J3ZK.js");
          } catch {
      ...
      async function initProvider() {
        const MetaMaskSDK = await (async () => {
          const { default: SDK } = await (() => {
            try {
              return import("./metamask-sdk-ZK2NCPGZ.js");
            } catch {
        ...
        try {
          if (!accounts?.length && !isReconnecting) {
            const { RpcSchema } = await (() => {
              try {
                return import("./connectors_false-FB7K2NVZ.js");
              } catch {
            ...
            const { z } = await (() => {
              try {
                return import("./connectors_false-AVABBWPY.js");
              } catch {
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      ...
      if (!provider_) {
        const { default: SDK } = await (() => {
          try {
            return import("./connectors_false-FTS265WG.js");
          } catch {
        ...
        const SafeAppProvider = await (async () => {
          const Provider = await (() => {
            try {
              return import("./connectors_false-GDM5QMLN.js");
            } catch {
    ...
    async getProvider({ chainId } = {}) {
      async function initProvider() {
        ...
        const { EthereumProvider } = await (() => {
          try {
            return import("./connectors_false-YXWK5C3C.js");
          } catch {
