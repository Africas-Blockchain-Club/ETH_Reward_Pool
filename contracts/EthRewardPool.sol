...
contract EthRewardPool is ReentrancyGuard {
    ...
    uint256 public constant MIN_CONTRIBUTION = 0.000000000000000001 ether;
    ...
    function joinPool() external payable roundOpen nonReentrant {
        ...
        require(msg.value >= MIN_CONTRIBUTION, "Minimum contribution is 0.000000000000000001 ETH");
